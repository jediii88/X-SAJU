...
function buildChapter6_Love(data) {
    ...
    const meetTiming = name + '님 인연은 운이 열릴 때만 오는 것이 아닙니다. **소개·모임**과 **의미 있는 관계를 만드는 만남과 이별의 패턴**이 열려 있어야 인연이 머무를 자리가 생깁니다. 기운이 맞는 해·달에만 **직무·취향이 맞는 소규모 커뮤니티** 참여를 늘리십시오.';
