...
function yearlyDomainStrategicAdvices(score) {
    ...
    return {
        wealth: sc >= 2
            ? '돈이 들어오는데도 마음이 조급했을 수 있습니다. 그건 탐욕이 아니라, 지켜야 할 것이 많았기 때문입니다. 이제 **미수·외주·보너스를 한 주에 한 축만** 다루십시오. 입금 확인 문자는 스크린샷으로 남기고, 금요일 저녁 한 번만 숫자를 맞추십시오.'
            : sc >= 0
            ? '벌어도 손에 잘 안 남는다고 느꼈을 수 있습니다. 당신이 허술해서가 아니라, 고정비와 잔금이 조용히 새는 해에 가깝습니다. **카드·자동이체는 주 단위로만** 열어보십시오. 큰 지출은 영업일 기준 이틀을 비우고, 현금 비중만이라도 분기마다 조금씩 올리십시오.'
            : '누군가에게 또 끌려가며 지갑을 열었을지 모릅니다. 그런데도 당신은 나쁜 사람이 아닙니다, 경계를 늦게 배웠을 뿐입니다. **연대보증·지분·가족 명의 대출 서명은 올해 안에 하지 마십시오.** 꼭 필요하면 변호사 검토 전에는 두 번째 페이지를 넘기지 마십시오.',
        career: sc >= 2
            ? '인정받고 싶어 더 많이 짊어졌을 수 있습니다. 그 마음이 부끄러운 일이 아닙니다. 다만 올해는 **연봉 숫자보다 직무 범위·보고 라인·야근 유무**를 먼저 이메일로 받아 두십시오. 구두 출근 명령에는 조직도에 이름이 찍히는 날짜를 적어 달라고 하십시오.'
            : sc >= 0
            ? '조용히 해도 일이 늘기만 했다면, 그건 당신이 무능해서가 아닙니다. 경계가 흐린 자리에 서 있었을 뿐입니다. **회의록마다 R&R 한 줄**을 남기십시오. 상사 교체·프로젝트 합병 때는 성과 지표를 다시 쓰게 한 뒤에만 새 업무에 손대십시오.'
            : '속으로는 이미 여러 번 사직서를 썼을지 모릅니다. 그래도 당신은 버틴 것입니다, 패배한 것이 아닙니다. **이력서는 먼저 올리지 마십시오.** 병가·연차로 호흡을 확보한 뒤, 내부 전배가 열리면 그쪽으로만 협상하십시오.',
        love: sc >= 2
            ? '좋은 사람이라 더 많이 맞춰왔을 수 있습니다. 그런데도 당신의 마음은 틀리지 않았습니다. **첫 만남에서 돈·지분 이야기가 나오면 그날은 관계만으로 끊으십시오.** 지갑과 계약은 다음 주 월요일 이후로 미루십시오.'
            : sc >= 0
            ? '연락이 잦을수록 오해가 쌓였을 수 있습니다. 그건 소통이 부족해서가 아니라, 피로가 먼저였을 가능성이 큽니다. **연락은 주 2회 고정 시간**으로 줄이십시오. 큰 결정은 만남 자리에서만 하십시오.'
            : '말이 통하지 않았다고 스스로를 탓했을지 모릅니다. 그러나 당신이 나쁜 사람이 된 것은 아닙니다. **헤어진 이·말 많은 지인에게 계좌 이야기를 하지 마십시오.** “지금은 답 못 준다” 한 문장만 반복하십시오.',
        health: sc >= 2
...
function injectSectionInterpretations(data) {
    ...
    const yongDetail = {
        wood: '목 기운이 용신입니다. 성장 에너지가 당신을 살립니다. 봄(2~4월), 갑·을년·갑·을 대운에 확장 신호가 강해집니다. 동쪽·초록·성장 업종이 길합니다. **간·담낭은 자정 전 취침**으로 먼저 지키십시오.',
        fire: '화 기운이 용신입니다. 표현 에너지가 당신을 살립니다. 여름(5~7월), 병·정년·병·정 대운이 전성기 축입니다. 남쪽·붉은색·열정이 필요한 분야가 길합니다. **카페인은 점심 이후 끊으십시오.**',
        earth: '토 기운이 용신입니다. 안정 에너지가 당신을 살립니다. 환절기(3·6·9·12월), 무·기년이 정비에 유리합니다. 중앙·황색·부동산·음식이 길합니다. **식사 시각만 고정**해도 흐름이 살아납니다.',
        metal: '금 기운이 용신입니다. 결단 에너지가 당신을 살립니다. 가을(8~10월), 경·신년·경·신 대운이 전성기 축입니다. 서쪽·흰색·IT·법·의료가 길합니다. **서명은 영업일 이틀 유예**하십시오.',
        water: '수 기운이 용신입니다. 지혜 에너지가 당신을 살립니다. 겨울(11~1월), 임·계년·임·계 대운이 전성기 축입니다. 북쪽·검정·물·무역·지식 산업이 길합니다. **물 2L와 수면 7시간**을 먼저 고정하십시오.'
    };
    setEl('yong-inline-summary', () => `<div class="inline-interp">
        ...
        <div class="ii-text">
            <p style="font-size:13.5px;color:#bbb;line-height:1.85;margin-bottom:16px;">용신은 원국의 불균형을 완화하는 축입니다. 흔들릴 때 자책하지 마십시오. 기운이 들쭉날쭉한 것은 성격 탓이 아니라, 들어오는 기운의 순서 때문입니다. <strong>용신이 강한 시기에는 확장, 기신이 강한 시기에는 수비</strong>만 먼저 고르십시오.</p>
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:14px;">
                ...
                <div style="background:rgba(74,158,106,0.08);border-radius:10px;padding:14px;border:1px solid rgba(74,158,106,0.4);">
                    ...
                    <p style="font-size:12px;color:#bbb;margin:8px 0 0;line-height:1.7;">${heeKr} 기운이 붙는 시기는 용신을 돕습니다. **보조 축은 하나만** 골라 집중하십시오.</p>
                </div>
            ...
            <div style="background:rgba(199,167,106,0.05);border-radius:10px;padding:14px 16px;border-left:3px solid var(--gold);">
                ...
                <p style="font-size:13px;color:#ddd;line-height:1.85;margin:0;">용신 색·방위를 생활에 붙이고, 용신 오행 일간인 사람을 파트너 후보에 넣으십시오. **용신이 강한 대운·세운에만 큰 결정**을 실어 보내십시오.</p>
            </div>
...
❤️ 올해 애정운 — 새 인연보다 <strong>기존 관계의 약속 이행</strong>을 먼저 채우십시오. 말보다 캘린더에 찍힌 행동이 신뢰를 만듭니다.
...
🏥 올해 건강운 — 쌓인 피로가 나중에 터질 수 있습니다. <strong>수면 7시간·음주 주 2회 이하·밤 11시 이후 근무 중단</strong>을 마지노선으로 삼으십시오.`;
    ...
    try {
        ...
        const mAdv = ms>=2
            ?`이달은 기운이 앞으로 밀려오는 달입니다. 망설였던 첫 실행을 붙잡기엔 좋습니다. <strong>【중요 결정·협상·첫 실행은 이번 주 안에 캘린더에만】</strong> 고정하십시오. 감정으로 열린 약속은 다음 달로 미루십시오.`
            :ms>=0
    ...
    return `<div class="report-chapter" style="border:2px solid var(--gold);border-radius:14px;padding:20px;background:rgba(199,167,106,0.04);">
        ...
        <p class="ch-text">대운은 10년 기후, 세운은 한 해의 날씨, 월운은 이달의 날씨입니다. ${nowY}년 ${nowM}월 지금 이 순간, 숫자와 사람 약속이 겹치는 주만 표시해 두셔도 충분합니다.</p>
...
function buildMasterFullReading(data) {
    ...
    const CHAR_MAP = {
        wood: `${nm}님께는 앞장서 길을 여는 본능이 있습니다. 그 과정에서 주변과 부딪치며 외로웠을 수 있으나, 그건 오만함이 아니라 목(木) 기운이 길을 여는 방식입니다. <strong>당신의 앞서감은 틀리지 않았습니다.</strong> 이제는 멈출 때의 공백을 두려워하지 마십시오. 다음 목표 한 가지만 달력에 적고, 쉬는 날은 의도적으로 비우십시오.`,
    ...
    const strongText = isStrong
        ...
        : `신약에 가깝습니다. 혼자 끙끙 앓기보다 믿을 사람 하나를 붙이면 배가 되는 구조입니다. <strong>용신 쪽 기운이 있는 환경·사람을 가까이 두십시오.</strong> 거절 한 번이 체력을 살립니다.`;
...
function buildPremiumExecutiveSummary(data) {
    ...
    var coreFusion = nm + '님께는 환경이 바뀔수록 숫자와 사람 약속이 한꺼번에 몰리는 구조가 있습니다. 그건 성격 탓이 아니라, 사주의 ' + (isStrong ? '신강한 추진 에너지' : '신약한 정밀 조율 에너지') + '와 자미두수 「' + palaceLabel + '」 명궁이 맞물린 결과입니다. <strong>흔들림을 기다리지 말고 변화의 순서를 직접 설계하십시오.</strong>';
...
function buildChapter1_Basic(data) {
    ...
    let lifeNarr = (function() {
        ...
        if(generates(mBrOh,dOh)) {
            ...
            mBrDRelation = '15~35세에는 말·속도·돈 기준이 비슷한 사람들이 곁에 붙습니다. 감정 소모가 큰 관계는 길게 가기 어렵습니다. **만남은 주 2회로 줄이고, 약속은 캘린더에만** 고정하십시오.';
        }
...
function buildChapter3_Sipseong(data) {
    ...
    const sipDB = {
        '비견':'비견이 두껍습니다. 지는 걸 견디기 어렵고, 내 방식이 먼저입니다. 동업에서 역할이 겹치면 마찰이 납니다. **역할·KPI를 문장으로 고정**하고 들어가십시오. 독립·경쟁 분야에 강합니다.',
        '겁재':'겁재가 두껍습니다. 위기와 승부에서 깨어납니다. 돈은 속도가 아니라 통제에서 남습니다. **충동 지출·보증은 원칙적으로 거절**하십시오. 협상·위기 대응에 쓰면 무기가 됩니다.',
        '식신':'식신이 두껍습니다. 만들고 맛보는 일에서 살아납니다. 재능이 곧 수입이 되도록 **‘판매 가능한 산출물’ 한 종류**만 먼저 고르십시오.',
        '상관':'상관이 두껍습니다. 틀을 깨는 쪽으로 뇌가 돌아갑니다. 조직 규율과 정면으로 부딪히면 비용이 큽니다. **자율 계약·프로젝트 단위**로 일하십시오.',
        '편재':'편재가 두껍습니다. 흐름과 기회에 민감합니다. 줄이 많으면 관리가 무너집니다. **현금흐름 표는 주 1회만** 열고, 나머지는 자동이체로 묶으십시오.',
        '정재':'정재가 두껍습니다. 신뢰와 꾸준함이 재물의 축입니다. 한 방보다 복리가 맞습니다. **저축·상환 자동이체 날짜**를 먼저 박으십시오.',
        '편관':'편관이 두껍습니다. 압박이 올수록 각이 살아납니다. 사회적으로 인정되는 장에 쏟지 않으면 마찰이 됩니다. **규칙이 있는 경쟁 구조** 안에 넣으십시오.',
        '정관':'정관이 두껍습니다. 질서·명예를 중시합니다. 평판이 곧 돈입니다. **약속·문서는 지키는 사람**으로만 브랜드를 쌓으십시오.',
        '편인':'편인이 두껍습니다. 남들과 다른 학습·직관이 강점입니다. **한 틈새 분야만** 정해 깊이를 쌓으십시오.',
        '정인':'정인이 두껍습니다. 배움과 귀인이 길을 엽니다. **공인·자격·문서**를 먼저 쌓으십시오.'
    };
    ...
    return `<div class="report-chapter">
        ...
        <p class="ch-text">오행이 몸이라면 십성은 반응 습관입니다. 돈·사람·권위 앞에서 튀어나오는 건 성격이 아니라 이 코드입니다.</p>
        <p class="ch-text">지금 가장 두꺼운 층은 <b style="color:var(--gold);">[${mainSip}]</b>입니다. 중요한 순간, 설명보다 먼저 움직이는 기준이 여기에 붙습니다.</p>
        <div style="background:rgba(199,167,106,0.07);border-left:3px solid var(--gold);padding:16px 18px;border-radius:0 8px 8px 0;margin:16px 0;">
        ...
        <p class="ch-text">이 기질을 도구로 쓰면 속도가 납니다. 기질에게 끌리면 같은 자리에서 반복됩니다. **한 달에 ‘이 기질 쓰는 날’과 ‘쉬는 날’**을 달력에 나누십시오.</p>
    </div>`;
}
...
function buildChapter4_Wealth(data) {
    ...
    const wealthDesc = wealthType === 'active'
        ? `${name}님은 현금이 손을 타고 흐를 때 힘이 납니다. 월급만으로는 속도가 안 맞을 수 있습니다. 그건 욕심이 아니라 구조입니다. **수익 축은 세 개 넘기지 마십시오.**`
        : `${name}님은 ‘이름·전문성·신뢰’가 쌓일수록 돈이 따라붙는 축입니다. 한탕보다 반복 계약이 맞습니다. **포트폴리오 한 줄 소개**를 먼저 고정하십시오.`;

    const wealthCaution = wealthType === 'active'
        ? `속도가 곧 함정입니다. 한 번의 과레버가 전부를 가져갑니다. **손실 한도·보증 거절**을 문장으로 적어 지갑 옆에 두십시오.`
        : `돈을 쫓으면 도망갑니다. 가격표를 먼저 올리십시오. **분기마다 ‘증명 가능한 성과’ 한 가지**만 대외에보내십시오.`;
    ...
    const daewunRows = rows.slice(0, 8).map((r, i) => {
        ...
        const intro = phase==='open'
            ? `${ganKr}${jiKr}(${age}~${endAge}세) — 흐름이 열립니다. 운이 밀어줄 때는 겸손이 아니라 집중이 필요합니다.`
            : phase==='guard'
            ? `${ganKr}${jiKr}(${age}~${endAge}세) — 새는 구간입니다. 벌기보다 **지출·계약·보증**부터 잠그십시오.`
            : `${ganKr}${jiKr}(${age}~${endAge}세) — 밭을 고르는 시기입니다. 판 키우기보다 **지금 먹고 있는 밥그릇**을 단단히 하십시오.`;
        const action = phase==='open'
            ? '**이 구간에만 실을 큰 결정 하나**를 미리 골라 두십시오.'
            : phase==='guard'
    ...
    return `<div class="report-chapter">
        ...
        <p class="ch-text">재물은 감이 아니라 리듬입니다. 벌 때와 줄 때를 구분하지 못하면 같은 실수가 반복됩니다. **용신 구간은 확장, 기신 구간은 수비**만 먼저 고르십시오.</p>
...
function buildDaewunLoop(data) {
    ...
    const GAN_DESC = {
        ...
        '己':'새 것보다 수확입니다. **정리·회수·계약 연장**에서 실속을 챙기십시오.',
    ...
    rows.forEach((r, idx) => {
        ...
        // 천간/지지별 맞춤 4분야 조언
        const WEALTH_GAN = {
            '甲':'씨앗을 심는 구간입니다. 당장 수익보다 **자산 구조 한 장**을 그리십시오.',
        ...
        const WEALTH_JI = {
            ...
            '寅':'움직임이 돈입니다. **이사·이직·새 채널** 중 하나만 고르십시오.',
            '卯':'사람이 문을 엽니다. **소개·협업 제안**을 먼저 보내십시오.',
            '辰':'변수가 겹칩니다. **신규 투자는 유예**하고 관망하십시오.',
            '巳':'서명이 필요합니다. **조건을 먼저 글로** 적고 도장을 찍으십시오.',
            '午':'평판이 수입입니다. **약속 이행**을 먼저 쌓으십시오.',
            '未':'감성이 상품이 됩니다. **콘텐츠·교육** 하나를 완성하십시오.',
            '申':'속도전입니다. **손실 한도 숫자**를 적고 움직이십시오.',
        ...
        // 애정 조언
        const loveAdv = sc>=2 ? '인연이 붙기 쉽습니다. **만남 수를 늘리기보다 기준 한 줄**을 먼저 쓰십시오.' : sc>=0 ? '안정 국면입니다. **대화 시간 고정**이 관계를 지킵니다.' : '오해 비용이 큽니다. **중요한 말은 문자로 남기고** 감정 결정은 유예하십시오.';
...
function buildChapter5_Career(data) {
    ...
    const careerDB = {
        officer:{label:'관리형 — 조직과 명예', desc:'관성이 두껍습니다. 규칙과 위계 안에서 빛납니다. 그건 순응이 아니라 **책임이 곧 브랜드**인 구조입니다. 공직·대기업·금융·법조에서 승진 트랙을 타십시오. **권한 범위를 문서로** 먼저 고정하십시오.', jobs:'공무원·대기업 임원·금융·법조·의료·경찰·군인'},
        creator:{label:'창조형 — 재능과 표현', desc:'식상이 두껍습니다. 남의 시스템에 끼면 소진됩니다. **내 이름이 붙은 산출물**이 곧 돈입니다. **주간 공개 일정**을 달력에 박으십시오.', jobs:'크리에이터·강사·작가·디자이너·마케터·기획자·개발자'},
        expert:{label:'전문가형 — 지식과 자격', desc:'인성이 두껍습니다. 따라오기 어려운 전문성이 자산입니다. **자격·논문·케이스**로 장벽을 쌓으십시오. 배움을 멈추면 나이가 들수록 약해집니다.', jobs:'의사·변호사·회계사·컨설턴트·연구원·교수·약사'},
        independent:{label:'독립형 — 자율과 경쟁', desc:'비겁·겁재 기운이 강하면 남 밑이 답답합니다. **자율 100% 자리**가 아니면 반토막입니다. 영업·사업·경쟁 구도에서 승부하십시오.', jobs:'사업가·영업·스포츠·부동산·트레이더·자영업'}
    };
...
function buildChapter6_Love(data) {
    ...
    const meetTiming = name+'님 인연은 운이 열릴 때만 오는 것이 아닙니다. 문이 열려도 **만남의 자리가 막혀 있으면** 스칩니다. 용신이 붙는 해·달에만 모임을 늘리십시오.';
    ...
    return `<div class="report-chapter">
        ...
        <div style="background:rgba(255,255,255,0.04);border-radius:10px;padding:18px;margin-top:16px;">
            ...
            <p style="font-size:13.5px;color:#bbb;line-height:1.9;margin:0;">완벽한 사람이 아니라 **내 빈틈 오행을 일간으로 가진 사람**이 보완에 강합니다. 일지 합이 맞으면 속도가 붙습니다. 머리의 이상형만 쫓지 마십시오.</p>
        </div>
