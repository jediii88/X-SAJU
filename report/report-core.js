...
function buildChapterHeadTopicFirst(mainTitle, eyebrowLabel, leadHook, opts) {
    ...
    return '<div class="ch-head-topic-first" style="margin-bottom:16px;' + extra + '">'
        + '<h2 class="ch-main-topic-title" style="font-family:\'Noto Sans KR\',sans-serif;font-size:clamp(24px,5.2vw,30px);font-weight:800;line-height:1.2;margin:0 0 6px;color:var(--text,rgba(255,255,255,0.96));">' + escHtmlAttr(mainTitle) + '</h2>'
        + subHtml
        + hookHtml
        + '</div>';
}
...
function buildManseGuide(data) {
    ...
    return '<details class="manse-guide" style="background:rgba(255,255,255,0.025);border:1px solid rgba(199,167,106,0.22);border-radius:14px;padding:16px 20px;margin:12px 0 18px;">'
        ...
        + '<div style="font-size:clamp(24px,5.5vw,32px);font-weight:800;color:#fff;line-height:1.2;">만세력 읽는 법</div></div>'
