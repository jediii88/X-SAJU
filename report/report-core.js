...
function buildReviewCallout(data) {
    ...
    return '<div class="report-review-callout sajux-glass-heavy" style="margin:40px auto 32px;padding:32px 26px;border-radius:22px;text-align:center;max-width:640px;">'
