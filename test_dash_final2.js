...
try {
    ...
    `);
    console.log("AV DESC:", dom.window.document.getElementById('av-desc').innerHTML);
    console.log("MANSE TABLE:", dom.window.document.getElementById('manse-table').innerHTML.substring(0,200) + "...");
    console.log("SUCCESS");
} catch (e) {
