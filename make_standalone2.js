...
const report = fs.readFileSync('report_engine_v6.js', 'utf8');
...
html = html.replace('<script src="report_engine_v6.js"></script>', `<script>\n${report}\n</script>`);

fs.writeFileSync('X-SAJU_PREVIEW_MOBILE.html', html);
console.log("Standalone HTML created for mobile delivery.");